...
.set(".st1, st0, st2, st3", {visibility:"hidden"})

.to(".bgnd", { opacity: 1, duration: 1.5 })
.to(".bgnd", { opacity: 0, duration: 1.5 })

.to(".abu-dabhi", { opacity: 1, duration: 2 }, "-=2")
.to(".abu-dabhi", { opacity: 0, duration: 2, delay: 1 })

.set(".st1, st0, st2, st3", {visibility:"visible"})
.fromTo(".st0", {drawSVG:0}, {duration: 5, drawSVG:"100%"}, "start-=2")
.fromTo(".st1", {drawSVG:0}, {duration: 5, drawSVG:"100%"}, "start+=0.3")
.fromTo(".st2", {drawSVG:0}, {duration: 5, drawSVG:"100%"}, "start+=0.3")
.fromTo(".st3", {drawSVG:0}, {duration: 5, drawSVG:"100%"}, "start+=0.3")

.to(".first_bgnd", { opacity: 1, duration: 2 }, "-=5")
.to(".first_bgnd", { opacity: 0, duration: 1.5 })

.to(".second_bgnd", { opacity: 1, duration: 2 }, "-=3")
